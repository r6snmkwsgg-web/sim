...
NEW_MATS = {
    ...
    'coat1':    (0.20, 0.13, 0.085),   # tweed
    'coat2':    (0.045, 0.055, 0.11),   # navy
    'coat3':    (0.09, 0.09, 0.095),   # charcoal
    'coat4':    (0.40, 0.26, 0.13),   # camel
    'coat5':    (0.06, 0.12, 0.075),   # bottle green
    'coat6':    (0.28, 0.08, 0.05),   # rust red
    'ink':      (0.05, 0.04, 0.035),
